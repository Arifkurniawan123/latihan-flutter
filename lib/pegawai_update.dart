...
import 'package:arif_app/model/m_pegawai.dart';
import 'package:arif_app/pegawai_detail.dart';
...
class _PegawaiUpdateState extends State<PegawaiUpdate> {
  ...
  void initState() {
    super.initState();
    setState(() {
      _nip.text = widget.pegawai.nip;
      _nama.text = widget.pegawai.nama;
      _tl.text = widget.pegawai.tl;
      _tlp.text = widget.pegawai.tlp;
      _password.text = widget.pegawai.password;
    });
  }
